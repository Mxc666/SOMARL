...
class CNNLayer(nn.Module):
    def __init__(self, obs_shape, hidden_size, use_orthogonal, use_ReLU, kernel_size=3, stride=1):
        ...
        active_func = [nn.Tanh(), nn.ReLU()][use_ReLU]  # 激活函数
...
class CNNBase(nn.Module):
    def __init__(self, args, obs_shape, goal_shape=(0,)):
        ...
        self.cnn = CNNLayer(obs_shape+goal_shape, self.hidden_size, self._use_orthogonal, self._use_ReLU)
