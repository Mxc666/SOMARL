...
def get_config():
    ...
    # params for training
    parser.add_argument("--num_agents", type=int, default=2)  # the number of agent
    parser.add_argument("--seed", type=int, default=1, help="Random seed for numpy/torch")  # set random seed
    ...
    #params for planner
    parser.add_argument("--num_symOption",type=int,default=8)  # the number of symbolic options


    # -------------------------------------- mappo
    parser.add_argument("--env_name", type=str, default='MoveBox_task0', help="specify the name of environment")
