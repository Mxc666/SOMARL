...
def get_config():
    ...
    #params for planner
    parser.add_argument("--num_symOption",type=int,default=14)  # the number of symbolic options


    # -------------------------------------- mappo
    parser.add_argument("--env_name", type=str, default='Ablation_FindTreasure', help="specify the name of environment")
    parser.add_argument("--experiment_name", type=str,
                        default='SOMARL_NonIntrinsic')
